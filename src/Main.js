  ...
  return (
      ...
      <div className='container'>
        ...
        {People.filter((person) => {
          ...
          if (person.title.toLowerCase().includes(users.toLowerCase())||person.firstName.toLowerCase().includes(users.toLowerCase())||person.lastName.toLowerCase().includes(users.toLowerCase())){
            return person;
          }
          }).map((person, key)=>{
